...
"}"));
        ...
        lblAin8Voltage->setGeometry(QRect(672, 174, 102, 38));
        ...
        lblIn2Name->setGeometry(QRect(276, 30, 200, 38));
        ...
        lblAin3Current->setGeometry(QRect(276, 138, 102, 38));
        ...
        lblAin5Voltage->setGeometry(QRect(672, 66, 102, 38));
        ...
        lblAin4Name->setGeometry(QRect(78, 174, 200, 38));
        lblInName = new QLabel(AxControl);
        lblInName->setObjectName(QString::fromUtf8("lblInName"));
        lblInName->setGeometry(QRect(672, 30, 200, 38));
        ...
        lblAin4Current->setGeometry(QRect(276, 174, 102, 38));
        ...
        lblIn1Name->setGeometry(QRect(78, 30, 200, 38));
        ...
        lblAin1Current->setGeometry(QRect(276, 66, 102, 38));
        ...
        lblAin7Voltage->setGeometry(QRect(672, 138, 102, 38));
        ...
        lblAin2State->setGeometry(QRect(376, 102, 100, 38));
        ...
        lblAin4State->setGeometry(QRect(376, 174, 100, 38));
        ...
        lblAin1State->setGeometry(QRect(376, 66, 100, 38));
        ...
        lblAin3State->setGeometry(QRect(376, 138, 100, 38));
        ...
        lblAin6State->setGeometry(QRect(772, 102, 100, 38));
        ...
        lblAin8State->setGeometry(QRect(772, 174, 100, 38));
        ...
        lblAin5State->setGeometry(QRect(772, 66, 100, 38));
        ...
        lblAin7State->setGeometry(QRect(772, 138, 100, 38));
